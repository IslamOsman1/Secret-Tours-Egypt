export const categories = [
  { slug: 'classic-tours', name: 'Classic Tours', icon: 'Landmark', image: 'https://images.unsplash.com/photo-1503177119275-0aa32b3a9368?auto=format&fit=crop&w=1200&q=85' },
  { slug: 'nile-cruises', name: 'Nile Cruises', icon: 'Ship', image: 'https://images.unsplash.com/photo-1568322445389-f64ac2515020?auto=format&fit=crop&w=1200&q=85' },
  { slug: 'day-trips', name: 'Day Trips', icon: 'Sun', image: 'https://images.unsplash.com/photo-1571401835393-8c5f35328320?auto=format&fit=crop&w=1200&q=85' },
  { slug: 'desert-safari', name: 'Desert Safari', icon: 'Compass', image: 'https://images.unsplash.com/photo-1509316785289-025f5b846b35?auto=format&fit=crop&w=1200&q=85' },
];

export const tours = [
  {
    _id: '1', slug: '8-days-cairo-nile-cruise', title: '8 Days Cairo & Nile Cruise', category: 'classic-tours',
    city: 'Cairo, Luxor & Aswan', duration: '8 Days / 7 Nights', price: 1140, oldPrice: 1290, rating: 4.9, reviews: 128,
    ...
    excerpt: 'Discover Cairo’s icons, fly south, and sail the Nile between Luxor and Aswan with private guided visits.',
    highlights: ['Private Egyptologist guide', '4 nights Nile cruise', 'Airport assistance', 'Daily breakfast'],
    itinerary: [
      { day: 1, title: 'Welcome to Cairo', text: 'Airport meet & assist, private transfer and hotel check-in.' },
      { day: 2, title: 'Pyramids & Grand Egyptian Museum', text: 'Explore Giza, the Sphinx and Egypt’s legendary ancient collection.' },
      ...
      { day: 5, title: 'Edfu & Kom Ombo', text: 'Sail south and explore two remarkable riverside temples.' },
  ...
  {
    _id: '2', slug: 'luxury-nile-cruise-5-days', title: '5 Days Luxury Nile Cruise', category: 'nile-cruises',
    city: 'Luxor to Aswan', duration: '5 Days / 4 Nights', price: 790, rating: 4.8, reviews: 94, featured: true,
    badge: 'Luxury', image: 'https://images.unsplash.com/photo-1572252009286-268acec5ca0a?auto=format&fit=crop&w=1200&q=85',
  ...
  {
    _id: '3', slug: 'cairo-private-day-tour', title: 'Private Cairo Highlights Day Tour', category: 'day-trips',
    city: 'Cairo & Giza', duration: '10 Hours', price: 135, rating: 5.0, reviews: 72, featured: true,
    badge: 'Top Rated', image: 'https://images.unsplash.com/photo-1503177119275-0aa32b3a9368?auto=format&fit=crop&w=1200&q=85',
  ...
  {
    _id: '4', slug: 'white-desert-camping', title: 'White Desert Overnight Adventure', category: 'desert-safari',
    city: 'Bahariya Oasis', duration: '2 Days / 1 Night', price: 250, rating: 4.9, reviews: 61, featured: true,
    badge: 'Adventure', image: 'https://images.unsplash.com/photo-1509316785289-025f5b846b35?auto=format&fit=crop&w=1200&q=85',
  ...
  {
    _id: '5', slug: 'alexandria-day-trip', title: 'Alexandria Private Day Trip', category: 'day-trips',
    city: 'Alexandria', duration: '12 Hours', price: 155, rating: 4.7, reviews: 49,
  ...
  {
    _id: '6', slug: 'red-sea-luxury-escape', title: 'Red Sea Luxury Escape', category: 'classic-tours',
    city: 'Hurghada', duration: '4 Days / 3 Nights', price: 620, rating: 4.8, reviews: 83,
